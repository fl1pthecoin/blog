var store = [{
        ...
        "excerpt":"Overview home page: mentioning moodle hostname admissions@schooled.htb phillips_manuel@staff.schooled.htb We find the moodle subdomain by fuzzing: $ ffuf -w /usr/share/seclists/Discovery/DNS/subdomains-top1million-5000.txt -u http://schooled.htb -H \"Host: FUZZ.schooled.htb\" -fw 5338 [snip] moodle [Status: 200, Size: 84, Words: 5, Lines: 2] :: Progress: [4989/4989] :: Job [1/1] :: 451 req/sec :: Duration: [0:00:15] :: Errors:...","categories": ["boxes"],
        "tags": ["freebsd","bsd","moodle","pkg"],
        "url": "http://localhost:4000/boxes/Schooled/",
        "teaser": null
      }]
